...
```
# vi /etc/exports		// configure node ip address. 
/nfs 192.168.100.0/24(rw,sync,no_root_squash,no_all_squash,no_subtree_check)
...
# ssh-copy-id -i /root/cube/cert/id_rsa.pub root@192.168.100.102
# ssh-copy-id -i /root/cube/cert/id_rsa.pub root@192.168.100.103
...
# cd /root/cube
# cube create --cube-image={harbor_ip}/cocktail/cubetool:1.0.2.B000004 (cubetool image version 
